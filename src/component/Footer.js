    ...
    return (
        <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
            <div className="grid grid-flow-col gap-4">
                <a className="link link-hover" href='/home#'>About</a>
                <Link className="link link-hover" to='home#contact'>Contact</Link>
                <a className="link link-hover" href='/home#'>skill</a>
                <Link className="link link-hover" to='home#project'>project</Link>
            </div>
            <div>
                <div className="grid grid-flow-col gap-4">
