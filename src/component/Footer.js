    ...
    return (
        <footer class="footer footer-center p-10 bg-base-200 text-base-content rounded">
            <div class="grid grid-flow-col gap-4">
                <a class="link link-hover" href='/home#'>About</a>
                <Link class="link link-hover" to='home#contact'>Contact</Link>
                <a class="link link-hover" href='/home#'>skill</a>
                <Link class="link link-hover" to='home#project'>project</Link>
            </div>
            <div>
                <div class="grid grid-flow-col gap-4">
